...
def conn_net():
    l = [   make_connected_layer(3072, 280),
            make_activation_layer(RELU),
            make_connected_layer(280, 280),
            make_activation_layer(RELU),
            make_connected_layer(280, 280),
            make_activation_layer(RELU),
            make_connected_layer(280, 280),
            make_activation_layer(RELU),
            make_connected_layer(280, 10),
            make_activation_layer(SOFTMAX)]
    return make_net(l)
...
# each hidden layer take the same amount of operations (in lecture it was mentioned that this was good practice and would 
# help balance the network). This meant that all the hidden layers would be relatively the same size.
